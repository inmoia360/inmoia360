...
export async function GET(req: Request) {
  ...
  try {
    ...
    const campaigns = await client.query('SELECT slug, name, product_label FROM marketing_pilot.campaigns ORDER BY id');
    ...
    return NextResponse.json({ ok: true, campaigns: campaigns.rows, bread_locations: locs.rows });
  } catch (e) {
