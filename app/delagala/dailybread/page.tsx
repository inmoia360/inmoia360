...
export default function DailyBreadLanding() {
    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .form-hl h1{font-family:'Playfair Display',serif;font-weight:900;font-size:clamp(38px,9vw,56px);line-height:.95;letter-spacing:-.02em;color:#fff;}
        ...
        .hero h2{font-family:'Playfair Display',serif;font-weight:700;font-size:clamp(38px,6.2vw,72px);line-height:1;letter-spacing:-.02em;max-width:18ch;margin:0 auto;}
        ...
        .hero h2 .cup-icon{display:inline-block;width:1.8em;vertical-align:-0.5em;margin:0 0.1em;}
        ...
        .subscribe-copy h3{font-family:'Playfair Display',serif;font-weight:700;font-size:clamp(34px,5vw,56px);line-height:1;letter-spacing:-.025em;margin-bottom:20px;}
        ...
        @media(max-width:520px){
          ...
          .hero h2{font-size:clamp(32px,8.5vw,48px);}
          ...
          <div className="form-card">
            {state !== 'success' ? (
              <form onSubmit={handleSubmit} noValidate>
                ...
                {/* Selector de tienda — cargado dinámicamente desde la BD */}
                {bars.length > 0 && (
          ...
          <h2>
            ...
            <span className="cup-icon" aria-hidden="true">
              <svg viewBox="0 0 132 115" xmlns="http://www.w3.org/2000/svg" style={{ width: '100%', height: 'auto', display: 'block', overflow: 'visible' }}>
                ...
                {/* hogaza */}
                <path d="M10 96 Q6 60 48 60 Q90 60 86 96 Q86 104 76 104 L20 104 Q10 104 10 96 Z" stroke="#0A0A0A" strokeWidth="5" fill="none" strokeLinejoin="round" />
                {/* cortes del pan */}
